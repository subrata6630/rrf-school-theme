...
function rrf_school_custom_theme_options()
{
  ...
  $custom_settings = array(
    ...
    'settings'        => array(
      ...
      array(
        'id'          => 'site_logo',
        'label'       => __('সাইট লোগো', 'rrf-education-theme'),
        'type'        => 'upload',
        'section'     => 'general_settings'
      ),
      array(
        'label'       => __('মোট মেনু‍ সাপোর্ট করবে', 'rrf-education-theme'),
      ...
      array(
        ...
        'std'         => __('&copy; ২০১৬, সর্বস্বত্ত সংরক্ষিত। সাইট ডিজাইন: <a href="https://sbtechbd.xyz">Sbtechbd Technologies</a>', 'rrf-education-theme'),
        'type'        => 'text',
        'section'     => 'text_changes'
      ),
      array(
